...
cta_stations_df_merge = cta_stations_df_merge[
    ["map_id", "red", "blue", "g", "brn", "p", "y", "pnk", "o", "location"]
]
...
cta_stations_df_merge["lat"] = (
    cta_stations_df_merge["location"].apply(lambda d: d.get("latitude")).astype(float)
)
cta_stations_df_merge["lon"] = (
    cta_stations_df_merge["location"].apply(lambda d: d.get("longitude")).astype(float)
)

cta_df = cta_df.merge(
    cta_stations_df_merge, how="left", left_on="station_id", right_on="map_id"
